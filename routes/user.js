...
import { postUser, signIn, resetPassword, verifyLink, saveNewPassword, deleteUser } from "../controller/user.js";
router.use(express.json());
router.use(express.urlencoded({ extended: true }));

// TODO 開發方便，create user 先不限制權限中間件
router.route("/users").post(/*isAuthorized*/ wrapAsync(postUser));
